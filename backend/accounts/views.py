...
class RegisterEmployeeView (APIView):
    ...
    def post(self, request, format=None):
        ...
        user_details = UserDetails.objects.create(username=username, employee_id=employee_id, is_employee=is_employee, is_admin=is_admin, is_manager=is_manager, first_name=first_name,
                                                  last_name=last_name, dob=dob, department_code=department_code, phone_number=phone_number, joining_date=joining_date, flat=flat, town=town, state=state, online=online, admin=admin, manager=manager)
        user_details.save()
